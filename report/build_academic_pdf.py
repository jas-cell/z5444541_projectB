...
def story():
    ...
    flow.append(
        P(
            ...
            "is only a distributional observation. It is not evidence of better prediction. The 120-headline "
            "worksheet can support later labelling, but its review column is blank on purpose and the pseudo-label "
